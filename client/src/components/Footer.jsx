...
export default function FooterCom() {
  return (
    <Footer container className='border border-t-8 border-rose-400'>
...
<div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
    ...
    <Footer.LinkGroup col>
        <Footer.Link href='https://www.github.com/usha-p' target='_blank' rel='noopener noreferrer'>
            Github
        </Footer.Link>
...
<Footer.Copyright href='#' by="Usha's blog" year={new Date().getFullYear()}/> 
